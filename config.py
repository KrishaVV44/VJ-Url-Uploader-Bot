...
class Config(object):
    ...
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://dopplershift79:RdPVPD7OrQmcvy6C@cluster0.69w2qyz.mongodb.net/?retryWrites=true&w=majority")
